...
//头部
			$('.header-nav').find('li').mouseenter(function(){
				...
				switch(Index){
					case 0:
						headerLine.stop(true,false).animate({left:'0%'},500);
						break;
					case 1:
						headerLine.stop(true,false).animate({left:'14%'},500);
						break;
					case 2:
						headerLine.stop(true,false).animate({left:'28%'},500);
						break;
					case 4:
						headerLine.stop(true,false).animate({left:'58%'},500);
						break;
					case 5:
						headerLine.stop(true,false).animate({left:'72%'},500);
						break;
					case 6:
						headerLine.stop(true,false).animate({left:'86%'},500);
						break;
			...
			$('.header-nav').find('li').mouseout(function(){
				$('.header-line').stop(true,false).animate({left:'-14%'},500);
				return;
			})
})